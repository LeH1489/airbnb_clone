...
const ListingClient: React.FC<ListingClientProps> = ({
  ...
  const disabledDates = useMemo(() => {
    ...
    //iterate all of reservation and create a range of date between startDate and endDate
  ...
  useEffect(() => {
    if (dateRange.startDate && dateRange.endDate) {
      //count how many days user have selected
